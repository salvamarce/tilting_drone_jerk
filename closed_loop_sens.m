...
[pos_dot,vel_dot,jerk,eul_dot,wB_dot,wB_ddot,w_tilt] = X_DOT(states,csi,wr_dot_des,w_tilt_des,drone_params);
[wr_dot_ctrl, w_tilt_ctrl] = CTRL(states,csi,K_lin,K_att,lin_ref,att_ref,params);  
...
PI_fun = Function('PI_FUN', {PI,PI_csi,states, csi, wr_dot_des, w_tilt_des, K_lin, K_att, lin_ref, att_ref, params, drone_params}, {PI_dot});
PI_csi_fun = Function('PI_CSI_FUN', {PI,PI_csi,states, csi, wr_dot_des, w_tilt_des, K_lin, K_att, lin_ref, att_ref, params, drone_params}, {PI_csi_dot});
