...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a108=arg[0]? arg[0][15] : 0;
  if (res[4]!=0) res[4][0]=a108;
  a108=arg[0]? arg[0][16] : 0;
  if (res[4]!=0) res[4][1]=a108;
  a108=arg[0]? arg[0][17] : 0;
  if (res[4]!=0) res[4][2]=a108;
  a108=sin(a8);
  a112=arg[4]? arg[4][6] : 0;
  a108=(a108*a112);
  a110=(a7*a108);
  a78=(a110*a21);
  a6=arg[4]? arg[4][2] : 0;
  ...
  a84=(a33*a84);
  if (res[6]!=0) res[6][0]=a84;
  a89=(a33*a89);
  if (res[6]!=0) res[6][1]=a89;
  a94=(a33*a94);
  if (res[6]!=0) res[6][2]=a94;
  a99=(a33*a99);
  if (res[6]!=0) res[6][3]=a99;
  a104=(a33*a104);
  if (res[6]!=0) res[6][4]=a104;
  a33=(a33*a20);
